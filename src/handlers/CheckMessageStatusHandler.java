...
public class CheckMessageStatusHandler implements HttpHandler {
	...
	public void handle(HttpExchange exchange) throws IOException {
		...
		if(Server.getMessagedPlayers().contains(request.getPlayerID())) {
			//System.out.println("Ready");
			response.setStatus("Recommendation is ready");
		}
		else {
			//System.out.println("Definitely Not Ready");
			response.setStatus("Recommendation is not ready");
		}
